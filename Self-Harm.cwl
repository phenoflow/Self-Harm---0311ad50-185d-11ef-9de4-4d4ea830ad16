...
steps:
  ...
  self-harm-constr---primary:
    run: self-harm-constr---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-steam---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: self-harm-constr---primary/output
  ...
  medic-self-harm---primary:
    run: medic-self-harm---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  self-harm-wrist---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: medic-self-harm---primary/output
